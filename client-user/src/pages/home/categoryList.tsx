...
const CategoryList = (): JSX.Element => {
    ...
    return <div className="relative w-[90%] h-auto min-h-[100px] flex flex-wrap justify-around items-center p-1 my-2">
        ...
        my-4">Category</div>
        <div className="w-full h-auto min-h-[100px] grid grid-cols-1 ssm:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-2">
            {type && type.map((t: CategoryType) => <div className="h-[100px] relative hover:scale-110 transition-all" onClick={() => navigate(`/search/${t.nameType}`)} key={t.idType}>
                ...
                ></div>
                <div className='absolute top-0 left-0 w-full h-full cursor-pointer truncate flex items-center justify-center font-bold font-tech-shark text-[20px] px-3 border border-solid borderr-zinc-50'
                    style={{

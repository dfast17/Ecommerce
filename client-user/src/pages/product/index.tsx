...
const Product = () => {
    ...
    return <div className='product w-full h-auto flex flex-col items-center justify-center overflow-x-hidden'>
        ...
        <div className='product-layout w-full md:w-[90%] h-auto min-h-[760px] flex flex-wrap justify-around content-around'>
